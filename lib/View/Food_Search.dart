...
class Food_Search extends StatelessWidget {
  ...
  Food_Search(
      {Key? key, required this.image, required this.name, required this.prix, required this.description, required this.restaurant,})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return
      FutureBuilder<List<String>>(
          future: RestauService().getTabCate(restaurant.id),
